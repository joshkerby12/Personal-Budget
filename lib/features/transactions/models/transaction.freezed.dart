...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,orgId,createdBy,date,amount,merchant,description,category,subcategory,bizPct,isSplit,receiptId,notes,createdAt);

@override
String toString() {
  return 'Transaction(id: $id, orgId: $orgId, createdBy: $createdBy, date: $date, amount: $amount, merchant: $merchant, description: $description, category: $category, subcategory: $subcategory, bizPct: $bizPct, isSplit: $isSplit, receiptId: $receiptId, notes: $notes, createdAt: $createdAt)';
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id, @JsonKey(name: 'org_id')  String orgId, @JsonKey(name: 'created_by')  String createdBy,  DateTime date,  double amount,  String merchant,  String? description,  String category,  String subcategory, @JsonKey(name: 'biz_pct')  double bizPct, @JsonKey(name: 'is_split')  bool isSplit, @JsonKey(name: 'receipt_id')  String? receiptId,  String? notes, @JsonKey(name: 'created_at')  DateTime createdAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Transaction() when $default != null:
return $default(_that.id,_that.orgId,_that.createdBy,_that.date,_that.amount,_that.merchant,_that.description,_that.category,_that.subcategory,_that.bizPct,_that.isSplit,_that.receiptId,_that.notes,_that.createdAt);case _:
  return orElse();
...
class _Transaction implements Transaction {
  const _Transaction({required this.id, @JsonKey(name: 'org_id') required this.orgId, @JsonKey(name: 'created_by') required this.createdBy, required this.date, required this.amount, required this.merchant, this.description, required this.category, required this.subcategory, @JsonKey(name: 'biz_pct') required this.bizPct, @JsonKey(name: 'is_split') required this.isSplit, @JsonKey(name: 'receipt_id') this.receiptId, this.notes, @JsonKey(name: 'created_at') required this.createdAt});
